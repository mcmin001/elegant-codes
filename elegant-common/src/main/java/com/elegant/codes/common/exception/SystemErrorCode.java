 ...
 */
public interface SystemErrorCode extends ErrorInfo{
    /**
     * 我方系统异常错误码枚举
     */
    enum Code implements SystemErrorCode {
        /**
         * 系统错误(本系统).
         */
        SYSTEM_ERROR_LOCAL("500100", "系统异常");
     ...
     */
    default SystemErrorCode as(String desc) {
